...
<form style="margin-left: 10px; float: center">
  ...
  <label for="exampleFormControlTextarea1">Estimez-vous que tous les objectifs qu'on vous a attribé sont atteints ?<span class="requis">*</span></label>
  ...
  <label for="exampleFormControlTextarea1">A combien de projets avez-vous contribué ?<span class="requis">*</span></label>
  <div class="custom-control custom-checkbox">
  ...
  <a href="quizOther.jsp"><button type="button" class="btn btn-primary">Confirmer</button></a>
