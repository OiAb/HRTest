...
<form style="margin-left: 10px; float: center">
   <div class="form-group">
    <label for="exampleFormControlTextarea1">Quels sont vos atouts et vos axes d'amélioration ?<span class="requis">*</span></label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
   <div class="form-group">
    <label for="exampleFormControlTextarea1">Avez-vous des exemples concrets de projets pour illustrer ce constat ?<span class="requis">*</span></label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
  <a href="finalFormulaire.jsp"><button type="button" class="btn btn-primary">Confirmer</button></a>
